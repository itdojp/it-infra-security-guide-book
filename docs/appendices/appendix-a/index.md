...
この付録では、本書で学んだセキュリティ実装を実際に導入・運用する際に活用できる包括的なチェックリストを提供します。組織の規模や業界に関わらず、段階的にセキュリティレベルを向上させるための実践的なガイドとして活用してください。
...
- [ ] 法的要件（GDPR 等）への対応がされている

## A.5 コンテナ・Kubernetes セキュリティチェックリスト
