...
この付録では、インフラセキュリティの学習と実装を継続的に進めるための信頼性の高い参考文献、標準規格、技術リソース、ツールを体系的に整理して提供します。
...
- Prisma Cloud (旧 `Evident.io`) - Cloud Security
...
情報源を選択する際は、以下の基準で評価することを推奨します。具体的には次のとおりです。
