...
> **この章で学ぶこと**
> - 効果的なSOC（Security Operations Center）の構築と運用方法を理解する
> - SIEM/SOARを活用した統合セキュリティ監視システムの実装を学ぶ
...
本節ではSOC運用の観点から全体像を扱います。詳細なインシデント対応プロセスの設計と継続的改善は[第9章](../chapter-chapter09/index.md)で扱います。
