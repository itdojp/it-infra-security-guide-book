...
Kubernetesの細かな権限管理により、[第5章で学んだ最小権限原則](../chapter-chapter05/index.md#53-アクセス制御と特権管理)をクラスター環境で実現します。
...
Kubernetesネットワークポリシーにより、[第4章で学んだネットワークセグメンテーション](../chapter-chapter04/index.md#43-ネットワークセグメンテーション戦略)をPodレベルで実現します。
...
**分散ログ分析**では、Kubernetesクラスター全体からのログを統合し、攻撃の全体像を把握します。[第5章で学んだログ管理システム](../chapter-chapter05/index.md#54-ログ管理とシステム監視)を拡張し、コンテナ固有のログ形式とメタデータに対応した分析を実装します。
